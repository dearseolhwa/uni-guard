...
const UG = (() => {
  ...
  /* ------------------------------------------------------------------ */
  const SEV = {
    emergency:  { label:'Emergency',  cls:'emergency',  color:'var(--ug-emergency)',  level:4 },
    warning:    { label:'Warning',    cls:'warning',    color:'var(--ug-warning)',    level:3 },
    advisory:   { label:'Advisory',   cls:'advisory',   color:'var(--ug-advisory)',   level:2 },
    prepared:   { label:'Preparedness', cls:'prepared', color:'var(--ug-prepared)',   level:1 },
  };
  const STAGES = [
    { key:'reported',   label:'Reported',            cls:'reported',   color:'#A9BAD3', note:'Submitted by citizen' },
    { key:'verified',   label:'Verified',            cls:'verified',   color:'#87BBFF', note:'Confirmed by official or corroboration' },
    { key:'dispatched', label:'Response Dispatched', cls:'dispatched', color:'#FFC659', note:'Responders en route' },
    { key:'resolved',   label:'Resolved',            cls:'resolved',   color:'#63E1A9', note:'Cleared and closed' },
  ];
  ...
  const DATA = {
    ...
    roles: [
      { id:'citizen',            name:'Marites Aquino',       title:'Resident',                          initials:'MA', scope:'Barangay Bonuan Gueset' },
      { id:'barangay_official',  name:'Reynaldo Soriano',     title:'Barangay Captain',                  initials:'RS', scope:'Barangay Bonuan Gueset' },
      { id:'lgu_ldrrmc',         name:'Cmdr. Elena Reyes',    title:'LDRRMO Head',                       initials:'ER', scope:'Citywide · Dagupan' },
    ],
    sessions: {
      citizen:           { name:'Marites Aquino',    initials:'MA', role:'citizen',           title:'Resident',         barangay:'Bonuan Gueset', scope:'Barangay Bonuan Gueset', email:'m.aquino@example.ph' },
      barangay_official: { name:'Reynaldo Soriano',  initials:'RS', role:'barangay_official', title:'Barangay Captain', barangay:'Bonuan Gueset', scope:'Barangay Bonuan Gueset', email:'r.soriano@dagupan.gov.ph' },
      lgu_ldrrmc:        { name:'Cmdr. Elena Reyes', initials:'ER', role:'lgu_ldrrmc',        title:'LDRRMO Head',      barangay:'',              scope:'Citywide · Dagupan',     email:'e.reyes@dagupan.gov.ph' },
    },
    hazards: ['Flash Flood','River Overflow','Landslide','Fire','Road Blockage','Storm Surge','Earthquake'],
    barangays: ['Bonuan Gueset','Bonuan Boquig','Tapuac','Poblacion','Lucao','Calmay','Tambac'],
    kpis: [
    ...
    incidents: [
      { id:'UG-2026-0142', hazard:'Flash Flood',   brgy:'Bonuan Gueset', area:'Riverside zone',      status:'dispatched', sev:'emergency', time:'10m ago',  desc:'Knee-deep water across the riverside road; two households requesting evacuation assistance.', corr:3, thumb:'flood',     units:2, x:0.26, y:0.46, r:0.115 },
      { id:'UG-2026-0141', hazard:'Landslide',     brgy:'Tambac',        area:'Mountain View Pass',  status:'verified',   sev:'warning',   time:'45m ago',  desc:'Soil and debris covering the inner lane; one vehicle stalled, no injuries reported.',        corr:3, thumb:'landslide', units:1, x:0.62, y:0.32, r:0.095 },
      { id:'UG-2026-0140', hazard:'Storm Surge',   brgy:'Bonuan Boquig', area:'Seawall promenade',   status:'reported',   sev:'advisory',  time:'1h 12m ago', desc:'Waves overtopping the seawall at high tide; promenade closed to the public.',               corr:1, thumb:'surge',     units:0, x:0.50, y:0.74, r:0.080 },
      { id:'UG-2026-0139', hazard:'Road Blockage', brgy:'Lucao',         area:'Diversion Road',      status:'resolved',   sev:'advisory',  time:'3h ago',   desc:'Fallen tree cleared by the barangay team; lane reopened to traffic.',                       corr:4, thumb:null,        units:0, x:0.22, y:0.70, r:0.0 },
      { id:'UG-2026-0138', hazard:'Fire',          brgy:'Poblacion',     area:'Public market district', status:'verified', sev:'emergency', time:'2h 5m ago', desc:'Contained stall fire behind the market row; BFP monitoring for flare-ups.',                corr:2, thumb:null,        units:3, x:0.60, y:0.58, r:0.090 },
      { id:'UG-2026-0137', hazard:'River Overflow', brgy:'Calmay',       area:'Calmay riverside',    status:'reported',   sev:'warning',   time:'22m ago',  desc:'River level rising toward the first flood marker; residents advised to prepare go-bags.',   corr:2, thumb:'flood',     units:0, x:0.36, y:0.18, r:0.085 },
    ],
    advisories: [
      { id:'ADV-2026-061', title:'River Overflow Warning: Bonuan Gueset', severity:'emergency', type:'Emergency',     area:'Bonuan Gueset, Bonuan Boquig', time:'12m ago', body:'The river has breached the first flood marker along the Bonuan Gueset riverside. Residents within 200 m of the bank must prepare to move to the Bonuan Gueset Covered Court. Bring water, medication, and identification.' },
      { id:'ADV-2026-060', title:'Suspension of Classes, All Levels',      severity:'warning',   type:'Emergency',     area:'Citywide',                     time:'1h ago',  body:'The City Disaster Risk Reduction and Management Office has suspended classes at all levels for today. Parents are advised to keep children indoors and monitor official channels.' },
      { id:'ADV-2026-059', title:'Coastal Advisory: Storm Surge Watch',    severity:'advisory',  type:'Emergency',     area:'Coastal barangays',            time:'3h ago',  body:'A storm surge watch is in effect for coastal barangays. Small sea vessels are prohibited from sailing. The seawall promenade is closed until further notice.' },
      { id:'ADV-2026-058', title:'Preparedness Drill: Duck, Cover, Hold',  severity:'prepared',  type:'Preparedness',  area:'Citywide',                      time:'2d ago',  body:'A citywide earthquake drill will run at 9:00 AM this Friday. Households, schools, and offices are encouraged to join and time their duck, cover, and hold practice.' },
      { id:'ADV-2026-057', title:'Go-Bag Checklist for the Wet Season',    severity:'prepared',  type:'Preparedness',  area:'Citywide',                      time:'4d ago',  body:'Keep a go-bag ready: three days of water and non-perishable food, flashlight, batteries, first-aid kit, whistle, copies of documents, and a power bank.' },
    ],
    centers: [
      { id:'EC-01', name:'Bonuan Gueset Covered Court',     brgy:'Bonuan Gueset', status:'open',   occ:118, cap:250, note:'Priority for riverside households' },
      { id:'EC-02', name:'Dagupan City Astrodome',          brgy:'Tapuac',        status:'full',   occ:620, cap:620, note:'No remaining slots' },
      { id:'EC-03', name:'Lucao Elementary School',         brgy:'Lucao',         status:'open',   occ:84,  cap:300, note:'Medical station on site' },
      { id:'EC-04', name:'Poblacion Barangay Hall',         brgy:'Poblacion',     status:'closed', occ:0,   cap:90,  note:'Undergoing roof repair' },
      { id:'EC-05', name:'Calmay National High School',     brgy:'Calmay',        status:'open',   occ:210, cap:400, note:'Pet-friendly area available' },
    ],
    hotlines: [
      { agency:'Dagupan City DRRMO',      number:'(075) 523-8181',   scope:'Citywide',           type:'emergency' },
      { agency:'Bureau of Fire Protection', number:'(075) 522-3333', scope:'Fire and rescue',    type:'emergency' },
      { agency:'PNP Dagupan City',        number:'0998-598-5391',    scope:'Police assistance',  type:'emergency' },
      { agency:'Philippine Coast Guard',  number:'(075) 542-6377',   scope:'Coastal rescue',     type:'emergency' },
      { agency:'Red Cross Dagupan',       number:'(075) 522-2133',   scope:'Medical and relief', type:'medical' },
      { agency:'Bonuan Gueset Barangay Desk', number:'0917-408-2210', scope:'Barangay hotline',  type:'barangay' },
    ],
    notifications: [
      { title:'Emergency: River Overflow Warning', body:'Bonuan Gueset and Bonuan Boquig residents: prepare to move to higher ground.', time:'12m ago', tone:'emergency', icon:'alert', unread:true },
      { title:'Your Report Was Auto-Verified',     body:'UG-2026-0142 reached 3 independent corroborations in Bonuan Gueset.',        time:'18m ago', tone:'prepared',  icon:'check', unread:true },
      { title:'Response Dispatched',               body:'Two rescue units are en route to the Riverside zone.',                         time:'26m ago', tone:'warning',   icon:'truck', unread:true },
      ...
      { title:'Preparedness Drill Reminder',       body:'Citywide earthquake drill this Friday at 9:00 AM.',                           time:'1d ago',  tone:'prepared',  icon:'flag',  unread:false },
    ],
  ...
  function mapSVG(opts){
    ...
    const W = 760, H = 430;
    const nodes = [
      ['Bonuan Gueset',176,196,1,-1],['Bonuan Boquig',232,252,0,1],['Tapuac',352,236,0,1],
      ['Poblacion',314,312,0,-1],['Lucao',196,320,0,1],['Calmay',296,130,0,1],
      ['Tambac',428,152,0,-1],['Sison',556,88,0,1],['San Fabian',516,182,0,1],
      ['Mangaldan',606,238,0,1],['Calasiao',470,308,0,1],['Lingayen',652,150,0,1],
    ];
    let grid = '';
    ...
    const land = '<path d="M0 214 C90 184 172 198 252 238 C342 284 432 280 522 242 C612 204 702 198 760 222 L760 430 L0 430 Z" ' +
      'fill="rgba(18,32,54,.62)" stroke="rgba(120,170,215,.17)" stroke-width="1"/>';
    ...
    let river = '<path d="M120 40 C160 120 150 180 190 220 C236 266 300 250 330 300 C356 344 420 356 520 340" fill="none" stroke="rgba(77,155,255,.3)" stroke-width="7" stroke-linecap="round"/>' +
                '<path d="M120 40 C160 120 150 180 190 220 C236 266 300 250 330 300 C356 344 420 356 520 340" fill="none" stroke="rgba(120,190,255,.35)" stroke-width="2" stroke-linecap="round"/>';
    ...
    return '<svg viewBox="0 0 '+W+' '+H+'" preserveAspectRatio="xMidYMid slice" role="img" aria-label="Live operations map of Dagupan City showing active incident perimeters and deployed units">' +
      ...
      '<text x="16" y="'+(H-14)+'" font-family="IBM Plex Mono, monospace" font-size="9.5" fill="#7E92AF">DAGUPAN CITY GRID · WGS84 · ZOOM 12</text>' +
    '</svg>';
  }

  function mapLegend(){
    return '<div class="map-legend">' +
      [['#FF5A5F','Emergency'],['#FFB020','Warning'],['#4D9BFF','Advisory'],['#34D6F0','Deployed unit']]
        .map(l => '<span class="lg"><i style="background:'+l[0]+'"></i>'+l[1]+'</span>').join('') +
    '</div>';
  }
...
const UG_SCREENS = (() => {
  ...
  const HAZARD_COLOR = (h) => /flood|overflow/i.test(h) ? '#FF5A5F'
    : /landslide|debris|erosion/i.test(h) ? '#FFB020'
    : /fire/i.test(h) ? '#FF8A4C'
    : /surge|typhoon|storm|coastal/i.test(h) ? '#4D9BFF'
    : /earthquake|quake|seismic/i.test(h) ? '#2FD08A'
    : '#8698B4';
    ...
    return '<div class="ug-col" style="gap:16px">' +
      ...
      '<div class="ug-field"><label class="ug-lab">Incident coordinates</label>' +
        '<div class="ug-geo"><span class="geo-ico">' + I('pin', 18) + '</span>' +
          '<span style="min-width:0"><span class="geo-val">' + (r.gps ? '16.0433, 120.3331' : 'Not acquired') + '</span>' +
  ...
  function mReportDone(st){
    ...
    return '<div class="ug-col" style="gap:16px">' +
      '<div class="ug-card ug-tick"><div class="ug-card-b ug-col" style="gap:12px;align-items:center;text-align:center;padding:22px 18px">' +
        ...
        '<p class="ug-dim" style="font-size:12px;line-height:1.5">Your hazard report is now in the Bonuan Gueset queue. Responders see it immediately.</p>' +
      ...
      '<div class="ug-card"><div class="ug-card-h"><h3>Crowd Corroboration</h3>' + U.badge('reported', '1 of 3') + '</div>' +
        ...
        '<div class="ug-rows" style="margin:0 -16px -16px">' +
          '<div class="ug-row"><span class="r-dot" style="background:var(--ug-signal)"></span><div class="r-main"><div class="r-t">You (' + esc(sess(st).name) + ')</div>' +
            '<div class="r-m"><span>' + I('clock', 12) + 'just now</span><span>' + I('pin', 12) + 'Riverside zone</span></div></div></div>' +
  ...
  function mReportDetail(st){
    ...
    return '<div class="ug-col" style="gap:14px">' +
      ...
      (auto ? '<div class="ug-card" style="border-color:rgba(47,208,138,.4)"><div class="ug-card-b ug-rowf ug-gap10" style="gap:10px;align-items:flex-start">' +
        ...
        '<div class="ug-dim" style="font-size:11.5px;margin-top:3px;line-height:1.5">Three independent residents reported the same hazard in Bonuan Gueset within the 6 hour window, so the report skipped manual approval.</div></div>' +
      '</div></div>' : '') +
  ...
  function mAdvisoryDetail(st){
    ...
    return '<div class="ug-col" style="gap:14px">' +
      ...
      '<div class="ug-rowf ug-gap12 ug-wrap" style="gap:12px;font-size:11px;color:var(--ug-ink-3)">' +
        ...
        '<span class="ug-rowf" style="gap:5px">' + I('shield', 13) + 'Dagupan City DRRMO</span></div>' +
    ...
    return '<div class="ug-col" style="gap:14px">' +
      ...
      list.map(c =>
        '<div class="ug-card"><div class="ug-card-b ug-col" style="gap:11px">' +
          ...
          '<div class="ug-rowf ug-gap8" style="gap:8px">' +
            '<button class="ug-btn ug-btn--sm" style="flex:1"' + A('directions', attr({ id: c.id, name: c.name })) + '>' + I('route', 14) + 'Directions</button>' +
  ...
  function dIncidents(st){
    const f = st.sevFilter;
    const chips = [['all', 'All'], ['reported', 'Reported'], ['verified', 'Verified'], ['dispatched', 'Response Dispatched'], ['resolved', 'Resolved']];
    ...
    return '<div class="ug-col" style="gap:14px">' +
      '<div class="ug-rowf ug-between ug-wrap" style="gap:12px;align-items:flex-start">' +
        ...
        '<div class="ug-rowf ug-gap8" style="gap:8px">' +
          ...
          (status !== 'resolved' ? '<button class="ug-btn ug-btn--sm ug-btn--signal"' + A('advance', attr({ id: i.id })) + '>' + I('check', 15) + 'Advance Status</button>' : '') +
        '</div>' +
      '</div>' +
          ...
          '<div class="ug-card"><div class="ug-card-h"><h3>Field Evidence</h3><span class="ug-dimmer ug-mono" style="font-size:10px">' + esc(i.id) + '_ev.jpg</span></div>' +
            '<div class="ug-card-b ug-col" style="gap:10px">' + (i.thumb ? U.thumb(i.thumb, 'bn-img', 'height:110px') : '') +
              ...
              '<div class="ug-rowf ug-gap12 ug-wrap" style="gap:12px;font-size:11px;color:var(--ug-ink-3)">' +
                ...
                '<span class="ug-rowf" style="gap:5px">' + I('pin', 13) + '16.0433, 120.3331 (6 m)</span>' +
        ...
        '<div class="ug-card ug-tick"><div class="ug-card-h"><h3>Compose Broadcast</h3>' +
          ...
          '<div class="ug-card-b ug-col" style="gap:0">' +
            '<div class="ug-field"><label class="ug-lab">Advisory title</label>' +
              '<input class="ug-in" data-field="advTitle" value="' + esc(d.title) + '" placeholder="e.g. River overflow warning: Bonuan Gueset"></div>' +
            ...
            '<div class="ug-field"><label class="ug-lab">Affected area</label>' +
              ...
              ['Citywide'].concat(U.DATA.barangays)
    ...
    return '<div class="ug-col" style="gap:18px">' +
      ...
      '<div class="ug-dgrid-centers">' + U.DATA.centers.map(c => {
        ...
        return '<div class="ug-card"><div class="ug-card-b ug-col" style="gap:12px">' +
          ...
          '<div class="ug-dimmer ug-rowf ug-wrap" style="font-size:11px;gap:10px"><span class="ug-rowf" style="gap:4px">' + I('pin', 12) + esc(c.brgy) + '</span>' +
            '<span class="ug-rowf" style="gap:4px">' + I('layers', 12) + esc(c.id) + '</span></div>' +
      ...
      '<div class="ug-card"><div class="ug-card-h"><h3>Add Evacuation Center</h3><span class="ug-dimmer" style="font-size:10.5px">Appears to citizens immediately</span></div>' +
        '<div class="ug-card-b"><div class="ug-rowf ug-gap12 ug-wrap" style="gap:12px;align-items:flex-end">' +
          '<div class="ug-field" style="flex:2;min-width:220px;margin:0"><label class="ug-lab">Center Name</label><input class="ug-in" data-field="centerName" placeholder="e.g. Calmay National High School"></div>' +
  ...
  const MTITLES = {
    home: ['UniGuard', 'Dagupan City, Pangasinan'],
  ...
  const DTITLES = {
    dashboard: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
    incidents: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
    incident: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
    advisories: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
    centers: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
    hotlines: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
    analytics: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
    notifications: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
    offline: ['UniGuard Command Console', 'Dagupan City, Pangasinan'],
  };
